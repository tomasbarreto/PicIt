...
@Composable
fun RepicRoomWaitingWinnerScreen(
    ...
    Column (
        ...
        {
            Text(text="Waiting for Winner", fontSize = 30.sp)
        }
        ...
        TimeLeftDisplay("Winner Announcement","1","24")
...
@Composable
fun RepicRoomWaitingWinnerPreview() {
    PicItTheme {
        RepicRoomWaitingWinnerScreen(room = RePicRoom())
    }
}